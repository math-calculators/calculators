...
//base area
  ...
  if (isNaN(area) || isNaN(sA)){
    ...
    document.getElementById('curnum').innerHTML = "Volume：" + volume + "<br>" + "Surface Area: " + sA+ "<br>" + "Base Shape Area: " + area+ "<br>" + "Base Shape Perimeter: " + perimeter;
    document.getElementById('curtex').innerHTML = "Your Results";
  }
  // Output results
...
function fun() {
  // Array of quotes
   ...
   // Display the quote
   alert(randomQuote);
   alert('also thank Grey for the quotes, not my fault if theyre a little weird');
}
