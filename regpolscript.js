...
document.addEventListener("DOMContentLoaded", () => {
  ...
  selectElement.addEventListener("change", (event) => {
    ...
    if (selectedValue == 15){
      selectedValue = parseInt(prompt("Input Number of Sides:"))
    }
...
function equals() {
  ...
  if (isNaN(sN) || isNaN(sL) || isNaN(apo) || isNaN(rad)) {
    document.getElementById('curnum').innerHTML = "Error! Given values are not possible.";
